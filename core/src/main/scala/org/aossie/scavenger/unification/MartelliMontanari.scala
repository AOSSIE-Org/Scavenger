package org.aossie.scavenger.unification

import org.aossie.scavenger.expression.{Abs, App, E, Sym, Var}
import org.aossie.scavenger.expression.substitution.immutable.Substitution
import org.aossie.scavenger.expression.substitution.mutable.{Substitution => MSub}
