package org.aossie.scavenger.prover.inferences
...
import org.aossie.scavenger.proof.cr.{CRProofNode, Conflict, ConflictDrivenClauseLearning, Decision, InitialStatement, UnitPropagationResolution}
import org.aossie.scavenger.prover.{ProblemStatus, Unsatisfiable}
import org.aossie.scavenger.prover.heuristic.{DecisionMaker, UnificationSearcher}
import org.aossie.scavenger.structure.immutable.{Clause, Literal}

import scala.collection.mutable
import scala.collection.mutable.ListBuffer
import scala.util.Random
import org.aossie.scavenger.unification.{MartelliMontanari => unify}
