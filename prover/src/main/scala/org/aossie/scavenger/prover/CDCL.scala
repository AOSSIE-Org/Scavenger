...
import org.aossie.scavenger.prover.choosing.{LiteralChooser, SimpleLiteralChooser}
import org.aossie.scavenger.prover.conflict.{ConflictAnalyser, SimpleConflictAnalyser}
