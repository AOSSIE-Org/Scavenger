 ...
 * 
 */
object EasyTPTPCNFUnsatNoEq extends Bench.OnlineRegressionReport {
  ...
  val problems = Seq(//"ANA013-2","ANA025-2","ANA037-2","ANA038-2","ANA039-2","ANA041-2","ANA042-2", // these problems are ok.
                     ...
                     //"COM001-1","COM002-2", // ok
                     "COM002-1", // This problem throws an exception
                     // "COM003-2","COM011-2", // ok
                     "FLD001-3", // This problem fails to load included axioms 
  ...
  performance of "Scavenger" in {
    measure method "EasyCNFUnsatNoEq" config (exec.benchRuns -> 1) in {
