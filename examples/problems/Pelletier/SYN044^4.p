%------------------------------------------------------------------------------
% File     : SYN044^4 : TPTP v6.4.0. Released v4.0.0.
...
% Status   : Theorem
% Rating   : 0.14 v6.4.0, 0.17 v6.3.0, 0.20 v6.2.0, 0.29 v6.1.0, 0.14 v5.5.0, 0.17 v5.4.0, 0.20 v5.3.0, 0.40 v5.1.0, 0.60 v5.0.0, 0.40 v4.1.0, 0.33 v4.0.1, 0.67 v4.0.0
% Syntax   : Number of formulae    :   48 (   0 unit;  23 type;  19 defn)
%            Number of atoms       :  141 (  19 equality;  48 variable)
