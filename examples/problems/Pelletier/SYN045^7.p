%------------------------------------------------------------------------------
% File     : SYN045^7 : TPTP v6.4.0. Released v5.5.0.
% Domain   : Syntactic
...
% Status   : Theorem
% Rating   : 0.14 v6.4.0, 0.17 v6.3.0, 0.20 v6.2.0, 0.43 v6.1.0, 0.29 v5.5.0
% Syntax   : Number of formulae    :   76 (   0 unit;  39 type;  32 defn)
%            Number of atoms       :  293 (  36 equality; 143 variable)
